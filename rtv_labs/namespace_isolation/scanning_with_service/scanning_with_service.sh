...
YAML="./scanning_with_service.yaml"

kubectl apply -f $YAML 
clear

echo $TICK"Creating resources for demo..."
echo $TICK"Dropping you into a pod in$BLUE eng1$NOCOLOR namespace"
echo $DIV
echo "Your goal is to find the other pod..."
echo "Note: This time, the dev team$PURPLE has$NOCOLOR gotten around to setting up services..."
...
kubectl exec -it -n eng1 nginx-eng1 -- bash
