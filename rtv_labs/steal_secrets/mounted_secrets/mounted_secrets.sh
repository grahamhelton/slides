...
echo $TICK"Dropping you into a$BLUE pod$NOCOLOR" 
echo $DIV
echo "Your goal is to access the$BLUE secrets$NOCOLOR in the pod..."


sleep 10 & spin
#echo $TICK"Waiting$BLUE 10 seconds$NOCOLOR for pod to start..."
kubectl exec -it secrets-mounted -- bash
